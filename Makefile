SRCS =  includes/get_next_line/get_next_line.c includes/get_next_line/get_next_line_utils.c main.c signals/signals.c syntax/syntax.c syntax/syntax_utils.c \
        ...
        builtins/export.c builtins/pwd.c builtins/unset.c builtins/export_utils.c builtins/exit.c builtins/manipulate_envs.c execution/run_parent.c safety/safe_functions.c heredoc/expand_heredoc.c heredoc/run_heredoc.c
